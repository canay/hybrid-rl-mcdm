...
RAW_DIR = REPO_ROOT / "data" / "raw" / "amazon_home"
PROC_DIR = REPO_ROOT / "data" / "amazon_home_real"
...
def save_outputs(item_table: pd.DataFrame, user_payloads: list[dict], max_users: int, min_unique_items: int) -> None:
    ...
    manifest = {
        ...
        "raw_meta": str(RAW_META_PATH.relative_to(REPO_ROOT)),
        "raw_reviews": str(RAW_REVIEW_PATH.relative_to(REPO_ROOT)),
